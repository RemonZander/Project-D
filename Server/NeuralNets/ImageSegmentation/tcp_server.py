...
class ImageSegmentationServer():
    def __init__(self, BUFFER_MAX=128, PORT_FLASK_TCP=5051, SERVER=socket.gethostbyname(socket.gethostname()), FORMAT="utf-8"):
    ...
    def handle_client(self, conn, addr):
        ...
        while connected:
            ...
            if recv_msg:
                ...
                user_index = 1
                complex_case = True
                resp_msg = Message(user_index, "RESPONSE MESSAGE segmentation!", complex_case)
